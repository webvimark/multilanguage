...
class MultiLanguageBehavior extends Behavior
{
	...
	public function mlAfterFind($event)
	{
		...
		if ( php_sapi_name() === 'cli' || Yii::$app->language == $this->mlConfig['default_language'] || in_array(Yii::$app->requestedRoute, $this->mlConfig['admin_routes']) )
		{
		...
		if (  php_sapi_name() === 'cli'  || in_array(Yii::$app->requestedRoute, $this->mlConfig['admin_routes']) )
		{
